...
declare namespace Api {
  namespace System {
    ...
    type ImportDictParams = {
      ...
      remark?: string;
      /** 字典数据列表 */
      dataList: ImportDictDataItem[];
    };

    /** 字典导入结果 */
    type ImportDictResult = {
    ...
    /** 字典排序参数 */
    type SortDictDataParams = {
      /** 字典类型 */
      dictType: string;
      /** 排序列表 */
      sortList: DictDataSortItem[];
    };
    ...
    type Tenant = Common.CommonRecord<{
      ...
      settlementChannel?: Api.FinanceCenter.SettlementChannelType | null;
      settlementReceiverType?: Api.FinanceCenter.SettlementReceiverType | null;
      settlementReceiverAccount?: string | null;
      settlementReceiverName?: string | null;
      settlementBankName?: string | null;
      settlementBankAccountNo?: string | null;
      settlementNeedManualReview?: boolean;
      settlementStatus?: Api.FinanceCenter.SettlementProfileStatus | null;
    ...
    type TenantOperateParams = CommonType.RecordNullable<
      ...
      > & {
        ...
        settlementEnabled?: boolean;
        settlementChannel?: Api.FinanceCenter.SettlementChannelType;
        settlementReceiverType?: Api.FinanceCenter.SettlementReceiverType;
        settlementReceiverAccount?: string;
        settlementReceiverName?: string;
        settlementBankName?: string;
        settlementBankAccountNo?: string;
        settlementNeedManualReview?: boolean;
        settlementStatus?: Api.FinanceCenter.SettlementProfileStatus;
    ...
    type Oss = Common.CommonRecord<{
      ...
      /** 服务商 */
      service: string;
      /** 存储方式：上传接口返回，local=本机磁盘，oss=阿里云（开发环境默认本地上传） */
    ...
    namespace FileManager {
      ...
      /* eslint-disable @typescript-eslint/no-shadow -- 文件管理子命名空间复用 System 级类型名 */
      /** 文件夹搜索参数 */
      type FolderSearchParams = CommonType.RecordNullable<
        Pick<Api.System.FileFolder, 'folderName' | 'parentId'> & Api.Common.CommonSearchParams
      >;
    ...
    type MessageSearchParams = CommonType.RecordNullable<
      Pick<Message, 'type' | 'isRead'> &
        Api.Common.CommonSearchParams & {
          /** 为 true 时仅返回发给当前管理员或租户级的站内信 */
          adminInbox?: boolean;
        }
    >;
