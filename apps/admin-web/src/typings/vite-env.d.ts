...
declare namespace Env {
  ...
  interface ImportMeta extends ImportMetaEnv {
    ...
    /** Whether to enable Vue devtools plugin in dev server */
    readonly VITE_VUE_DEVTOOLS?: CommonType.YesOrNo;
    /** Whether to enable Monaco editor worker plugin in dev server */
    readonly VITE_MONACO_DEV?: CommonType.YesOrNo;
    /** The launch editor */
