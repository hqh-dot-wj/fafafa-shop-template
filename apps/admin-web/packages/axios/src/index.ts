...
import { BACKEND_ERROR_CODE, REQUEST_CANCELED_CODE, REQUEST_ID_KEY, REQUEST_TRACE_ID_KEY } from './constant';
import type {
...
function createCommonRequest<ResponseData = any>(
  ...
  instance.interceptors.request.use((conf) => {
    ...
    config.headers.set(REQUEST_TRACE_ID_KEY, String(config.headers.get(REQUEST_TRACE_ID_KEY) || requestId));
...
export { BACKEND_ERROR_CODE, REQUEST_CANCELED_CODE, REQUEST_ID_KEY, REQUEST_TRACE_ID_KEY };
