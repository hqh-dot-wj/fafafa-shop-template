...
// FAFAFA-PIVOT-PHASE2-2026-06：移除 fetchChangeTenant / fetchClearTenant
// 单实例单租户模板模式下不再需要平台管理员运行时切换租户。
// 平台租户管理 CRUD（fetchGetTenantList / fetchCreateTenant 等）仍保留，供
// `views/system/tenant/**` 作为「本店信息」管理入口（Phase 4 将改造为店铺设置页）。
