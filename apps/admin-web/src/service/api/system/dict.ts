...
/** 批量导入字典 */
export function fetchImportDict(data: Api.System.ImportDictParams[]) {
  return request<Api.System.ImportDictResult>({
    url: '/system/dict/import',
    method: 'post',
    data,
  });
}
...
/** 获取字典统计 */
export function fetchGetDictStats() {
  return request<Api.System.DictStatsSummary>({
    url: '/system/dict/stats',
    method: 'get',
  });
}
