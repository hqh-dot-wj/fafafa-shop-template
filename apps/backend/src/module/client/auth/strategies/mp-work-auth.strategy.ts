 ...
 *
 * @description
 * 使用微信小程序 jscode2session 接口换取 openid（MP_WORK appid/secret），
 * 使用微信手机号快速验证接口获取手机号。
 */
@Injectable()
export class MpWorkAuthStrategy implements IClientAuthStrategy {
  readonly platform = SocialPlatform.MP_WORK;
