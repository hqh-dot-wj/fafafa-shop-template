 ...
 */
const pageMetaList = pages as PageMetaDatum[];
const homePagePath =
  pageMetaList.find((page) => page.type === 'home')?.path ?? pageMetaList[0]?.path ?? 'pages/index/index';

export const HOME_PAGE = `/${homePagePath}`;
